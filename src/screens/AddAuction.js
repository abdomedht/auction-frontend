...
const AddAuction = () => {
    ...
    const validationSchema = Yup.object().shape({
        ...
        startAuctionPrice: Yup.number()
            ...
            .positive("Must be a positive number"),
        startAuctionDate: Yup.date().required(
            "Start Date and Time are required"
        ),
        endAuctionDate: Yup.date()
            .required("End Date and Time are required")
            .min(
                Yup.ref("startAuctionDate"),
                            ...
                            <>
                                ...
                                <View>
                                    ...
                                    <TouchableOpacity
                                        ...
                                        <Text>
                                            {values.startAuctionDate.toLocaleString()}
                                        </Text>
                                    </TouchableOpacity>
                                    {isStartPickerOpen && (
                                        <DateTimePicker
                                ...
                                <View>
                                    ...
                                    <TouchableOpacity
                                        ...
                                        <Text>
                                            {values.endAuctionDate.toLocaleString()}
                                        </Text>
                                    </TouchableOpacity>
                                    {isEndPickerOpen && (
                                        <DateTimePicker
                                ...
                                {/* Start Auction Price */}
                                <View>
                                    {touched.startAuctionPrice &&
                                        errors.startAuctionPrice && (
                                            <Text style={styles.error}>
                                                {errors.startAuctionPrice}
                                            </Text>
                                        )}
