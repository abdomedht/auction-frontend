        ...
        <Formik
          ...
          validationSchema={Yup.object().shape({
            ...
            buyPrice: Yup.number()
              ...
              .integer("Buy price must be an integer"),
            startAuctionPrice: Yup.number()
              .required("*required")
              .positive("Start auction price must be positive")
              .integer("Start auction price must be an integer"),
            auctionDuration: Yup.number()
              .required("*required")
              .positive("Auction duration must be positive")
              .integer("Auction duration must be an integer"),
          })}
          ...
          {({
            ...
            <>
              ...
              <TextInput
                ...
                keyboardType="numeric"
              />
              {touched.auctionDuration && errors.auctionDuration && (
                <Text style={styles.error}>{errors.auctionDuration}</Text>
              )}
              <TextInput
                style={styles.input}
